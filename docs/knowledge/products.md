...
- **Status:** DRAFT / unpublished _(confirmed 2026-08-18: `/products/oatmeal-aloe-shampoo-gallon.js` 404 both markets). Homepage tile kept 2026-08-18 — restock inbound. Do not activate this round._
...
12. **Homepage economics + draft tiles.** Dilution band computes live from `wash-economics` (small = up to ~435; medium = avg $/wash from deshedding-shampoo). Hero slide 3 retargeted to `hypoallergenic-shampoo-gallon`. FUR-011 tile kept (restock inbound). FUR-001 SHOP NOW kept (inbound). Existing sulfate-free homepage sentence kept — INCI metafields still need the corrected lists before broader claim reinstatement. Pet-owner hero + Bella/Charlie kept. Source: `site/theme/sections/fg-dilution-callout.liquid` + `templates/index.json`. Pickup: `analyses/2026-08-18-eod-handoff.md`.
...
- **2026-08-18** — Homepage live: dilution band wired to wash-economics; hero 404 retargeted to hypoallergenic. Stephen: keep FUR-011 tile, FUR-001 SHOP NOW, sulfate sentence, pet-owner hero, Bella/Charlie. INCI metafield correction still open (issue 9).
