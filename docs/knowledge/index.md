...
- [PDP Phase 2 — four-section accordion, comparison block, chip strip, display titles](./analyses/2026-08-14-pdp-phase2-build.md) — filed 2026-08-14 as `brief` · Dandylion-informed Phase 2 build: `description-accordion.liquid` v2 (INCI auto-merged into an "ingredients" section, "how-it-compares" section auto-extracted below the accordion as a compact card; backwards-compatible with v2/v3 bodies + samples, simulation-verified), v4 deshedding exemplar description (best-for bullets / dilution protocol / ingredients & safety / shipping; canonical shipping windows; sulfate claim still held), curated `custom.faqs` v2 (12→9 with FUR20 + shipping fixes, ready for MCP push), at-a-glance chip-strip restyle, `custom.display_title` + gallon eyebrow support in the title block (inert until metafield created), proposed short titles for all 9 SKUs filed in products.md (Class B, awaiting approval); **theme files pushed 2026-08-14 to unpublished duplicate `#152547065995`** (v4 body + faqs v2 still pending MCP)

- [PDP Phase 1 — buy-box hierarchy, at-a-glance specs, accordion polish](./analyses/2026-08-14-pdp-phase1-buybox.md) — filed 2026-08-14 as `brief` · External design review of the accordion preview assessed (adopted: buy-box primacy, quantity + mobile sticky ATC, at-a-glance spec panel, computed $/working gallon; rejected: hardcoded prices, aria retrofit on native `<details>`, dropping named-competitor comparison, fabricated review stars); Stephen's five decisions recorded (sulfate hold, CA 2–5 / US 3–5 shipping, FUR20 manual entry, claims substantiated via 60+ groomer testing, review app pending); Phase 1 shipped repo-side in `site/theme/` and pushed 2026-08-14 to unpublished duplicate `#152547065995` (live theme not published); wholesale restyled to **Apply for salon pricing**; Search & Discovery complementary pairings still admin-pending
